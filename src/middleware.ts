...
export async function middleware(request: NextRequest) {
  ...
  console.log(`[Middleware] Pathname: ${pathname}`); // Log the path
  ...
  console.log(`[Middleware] Token: ${JSON.stringify(token)}`); // Log the token
...
export const config = {
  matcher: [
    // Use the original, more specific matcher
